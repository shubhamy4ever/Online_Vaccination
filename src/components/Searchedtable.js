...
export const Searchedtable = (props) => {
  return (
    <>
      <div className="my-4" style={props.name===""?{"display":"none"}:{"display":"block"}}>
        <table className="table">
          <tbody>
            ...
            <tr>
              ...
              <td>
              <button type="button" disabled={props.slots<1?true:false} className="btn btn-success my-4">Book Now</button>
              </td>
            </tr>
